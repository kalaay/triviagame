...
function finalScreen() {
  gameHTML =
    ...
    counter +
    "</span></p>" +
    "<p class='text-center'>You're done, lets see how you did!" +
    "</p>" +
...
var answerArray = [
  ...
  ["Baidoa", "Kismayo", "Mogadishu", "Berbera"],
...
var imageArray = [
  "<img class='center-block img-right' src='img/australia.jpeg'>",
  "<img class='center-block img-right' src='img/liberia.png'>",
  "<img class='center-block img-right' src='img/somalia.jpeg'>",
  "<img class='center-block img-right' src='img/japan.jpeg'>",
  "<img class='center-block img-right' src='img/china.png'>",
  "<img class='center-block img-right' src='img/turkey.jpeg'>",
  "<img class='center-block img-right' src='img/colombia.jpeg'>",
  "<img class='center-block img-right' src='img/india.jpeg'>"
];
var correctAnswers = [
  "A. Canberra",
  "B. Monrovia",
